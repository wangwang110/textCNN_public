...
def get_minibatches_idx(n, minibatch_size, shuffle=False):
    ...
    ## get_minibatches_idx(len(train), opt.batch_size, shuffle=True)
...
def cal_BLEU(generated, reference, is_corpus = False):
    ...
    ##cal_BLEU([prepare_for_bleu(s) for s in res['rec_sents']], {0: val_set})
